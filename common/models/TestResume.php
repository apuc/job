 ...
 */
class TestResume extends WorkActiveRecord
{
    ...
    {
        return [
            [['status', 'created_at', 'updated_at', 'employment_type_id'], 'integer'],
            [['title', 'first_name', 'second_name', 'phone', 'email', 'city', 'image_url', 'skype', 'instagram', 'facebook', 'vk'], 'string', 'max' => 255],
            [['description'], 'string'],
